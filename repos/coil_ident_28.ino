...
void setup()
{
  ...
  //EEPROM[6] = 180; /* BODY FLEX LOW */                      EEPROM[518] = 141; /* BODY FLEX LOW */
  //EEPROM[7] = 182; /* BODY FLEX HIGH */                     EEPROM[519] = 143; /* BODY FLEX HIGH */
...
{                                                       
      ...
      {  
        ...
        key = true;                                      
        lcd.setCursor(0, 1);                             
        lcd.print("NV/Body4ch id1 is OK");                 
      }                                                   
}   
